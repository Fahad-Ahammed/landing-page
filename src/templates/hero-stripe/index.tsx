      ...
      <section className="bg-[#200D00]">
        <div className="mx-auto w-[90%] max-w-[1300px] py-[50px]">
          <div className={`${articulate.className} lg:mb-[30px] xl:mb-[50px] `}>
            <h1 className="mb-[5px] text-center text-[12px] font-bold uppercase leading-[12px] tracking-[2px] text-[#FF6435] md:text-[14px] md:leading-[14px] xl:mb-[10px] xl:text-[16px] xl:leading-[16px] ">
              {data?.subTitle}
            </h1>
          ...
          <div className="hidden lg:block">
            ...
            <Link
              href="/"
              className="cursor-pointer text-[18px] leading-[29px] text-[#FF6435] underline "
            >
              {data?.readMoreText}
            </Link>
          </div>
